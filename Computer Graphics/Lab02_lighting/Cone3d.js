...
THREE.Cone3d.prototype.squint = function () {
  ...
  if (this.leftEye.material.map.offset.x < 0.38) {
    this.leftEye.material.map.offset.x =
      this.leftEye.material.map.offset.x + 0.01;
    this.rightEye.material.map.offset.x =
      this.rightEye.material.map.offset.x - 0.01;
    this.leftEye.material.map.offset.y =
      this.leftEye.material.map.offset.y + 0.008;
    this.rightEye.material.map.offset.y =
      this.rightEye.material.map.offset.y + 0.008;
